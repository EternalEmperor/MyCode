...
<head>
    ...
    <script src="statics/js/colog/collector.js" type="text/javascript"></script>
    <title>易买网</title>
</head>
<body>  
<!--Begin Login Begin-->
            ...
            <table border="0" style="width:370px; font-size:14px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr height="50" valign="top">
                ...
                <td>
                    ...
                    <span class="fr">还没有商城账号，<a href="${ctx}/Register?action=toRegister" style="color:#ff4e00;" onclick="collector();">立即注册</a></span>
                </td>
              </tr>
              <tr height="70">
                <td>用户名</td>
...
<!-- <script type="text/javascript">
    ...
    (function () {
        ...
        ma.async = true;
        ma.src = "http://localhost:8091/statics/js/colog/ma.js";
